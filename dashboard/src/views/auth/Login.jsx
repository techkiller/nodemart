        ...
        <div className='min-w-screen min-h-screen bg-[#222831] flex justify-center items-center'>
            <div className='w-[480px] text-[#EEEEEE] p-2'>
                <div className='bg-[#393E46] p-6 rounded-md shadow-md'>
                    ...
                    <h2 className='text-xl mb-3 font-medium text-center'>Welcome Back</h2>
                    <p className='text-sm mb-5 font-medium text-center'>Login to Your Account</p>
                    ...
                    <form onSubmit={submit}>
                        ...
                        <div className='text-right text-sm mb-5'>
                            <Link to="/forgot-password" className="text-[#0171e0] hover:underline">Forgot password?</Link>
                        </div>
                        <button
                        ...
                        <div className='text-center'>
                            <p>
                                ...
                                <Link to='/register' className="font-bold text-[#0171e0] hover:underline">
                                    Sign Up
                                </Link>
                            </p>
                        </div>
